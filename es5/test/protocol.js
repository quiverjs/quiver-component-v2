...
var protocol = $traceurRuntime.assertObject(require('../lib/protocol.js')).protocol;
var abstractComponent = $traceurRuntime.assertObject(require('../lib/abstract.js')).abstractComponent;
