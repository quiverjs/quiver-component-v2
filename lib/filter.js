...
var handlerFilterClass = (filterKey, handlerKeys) =>
...
export var StreamFilter = handlerFilterClass('_streamFilter', ['streamHandler'])
export var HttpFilter = handlerFilterClass('_httpFilter', ['httpHandler'])
