...
($traceurRuntime.createClass)(SimpleHandlerBuilder, {
  ...
  toJson: function() {
    let json = $traceurRuntime.superGet(this, $SimpleHandlerBuilder.prototype, "toJson").call(this);
...
let simpleHandlerBuilder = (function(builder, inType, outType, options) {
  return new SimpleHandlerBuilder(builder, inType, outType, options);
});
let simpleHandler = (function(handler, inType, outType, options) {
