...
($traceurRuntime.createClass)(InputHandlerMiddleware, {
  ...
  toJson: function() {
    let json = $traceurRuntime.superGet(this, $InputHandlerMiddleware.prototype, "toJson").call(this);
...
let mixinInputHandler = (function(prototype) {
  return Object.assign(prototype, InputHandlerMixin);
});
mixinInputHandler(ExtensibleComponent.prototype);
let inputHandlerMiddleware = (function(handler, toConfig, options) {
